...
"comments" : [
	...
	},
	{
		"el": ".favicon",
	 	"title" : "Favicons",
	 	"comment": "Favicons have been created which are compatible with all browsers and all platforms, including various mobile technologies. These icons not only are used for browser tabs, but when a user bookmarks the site and saves it to their home screen. Favicon image files should be placed in the root of the website, and the code is contained within the head tag."
	},
	{
	 	"el": "#nav",
	 	"title" : "Navigation",
